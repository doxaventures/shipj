...
class AllapiController extends Controller
{
    ...
    // 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
...
print_r($rates);
    ...
    public function createindicium(Request $request)
    {
        ...
        $collects=array();
           $var = shopify_call('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','jigar-omtec.myshopify.com','/admin/api/2020-10/customers.json','GET',$collects);
...
// =================== Insert Product in Shopify ==============================
  ...
  $data='{
            ...
            $var = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/products.json','POST',$collects);
     ...
     $collectsvariant = json_decode($variant, true);  
           ...
           $collectsvariantshow = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/products/'.$prodectinsert ->product->id.'/variants.json','POST',$collectsvariant);

             $p= json_decode($collectsvariantshow['response']);

           $getproduct = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/products/'.$prodectinsert ->product->id.'.json','GET',$query = array());

$getproduct_show= json_decode($getproduct['response']);


           $locationsget = shopify_call('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','ship-jam.myshopify.com','/admin/api/2021-01/locations.json','GET',$query = array());
     ...
     $collectsvariant = json_decode($variant, true);  
           ...
           $collectsvariantshow = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/inventory_levels/adjust.json','POST',$collectsvariant);
     ...
     // // https://{shop}.myshopify.com/admin/api/2021-01/inventory_levels/adjust.json
      ...
      // $collectsvariantshow = shopify_call('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','ship-jam.myshopify.com','/admin/api/2021-01/inventory_levels/adjust.json','POST',$collectsvariant);
      ...
      //   $p= json_decode($collectsvariantshow['response']);
           ...
           // $inventorylevels = shopify_call('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','ship-jam.myshopify.com','/admin/api/2021-01/locations/36678631618/inventory_levels.json','GET',$query = array());
      ...
      // $pshow = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/products/'.$prodectinsert ->product->id.'.json','GET',$collectsvariant);
  ...
  //     $democheck = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/checkouts.json','POST',$collectscheckouts);  

  //   $democheck1 = json_decode($democheck['response'], true);

  // $democheck222 = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/checkouts/b07d442c2084c10589ad08c6f8525d0b.json','GET',$collectscheckouts);
  ...
  //     $democheck22_all = shopify_call('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','ship-jam.myshopify.com','/admin/api/2020-10/checkouts.json','GET',$collectscheckouts);
